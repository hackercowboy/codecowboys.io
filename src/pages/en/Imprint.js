    ...
    return (
      <Content space>
        ...
        <Container className="article">
          ...
          <p>Responsibility for the content of external links (to web pages of third parties) lies solely with the operators of the linked pages. No violations were evident to me at the time of linking.
            Should any legal infringement become known to us, i will remove the respective link immediately.</p>
          <h2>Copyright</h2>
          ...
          <p>Unless expressly permitted by law, every form of utilizing, reproducing or processing works subject to copyright protection on my web pages requires the prior consent of the
            ...
            Unauthorized utilization of copyrighted works is punishable by the copyright law.</p>
        </Container>
      </Content>
    );
  }
