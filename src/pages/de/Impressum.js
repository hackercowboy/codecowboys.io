    ...
    return (
      <Content space>
        ...
        <Container className="article">
          ...
          <h2>Urheberrechte</h2>
          <p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf der Website gehören ausschliesslich David Übelacker oder den speziell genannten Rechtsinhabern.
